...
/***
Categories we considered as "tech" are: ('telephony', 'computers_accessories','electronics','computers', 'audio')
***/
...
SELECT product_category_name_english AS Category, COUNT(DISTINCT o.order_id) AS Order_Quantity, 
CASE 
...
HAVING
    product_category_name_english in ('telephony', 'computers_accessories', 'electronics', 'computers', 'audio');
